...
crontab -l | { cat; echo '@reboot GOOGLE_APPLICATION_CREDENTIALS="/home/pi/engineering-good-1569744069426-f14580c084fd.json" python3 /home/pi/Desktop/eyeHear/main.py  >> /home/pi/eyeHear.log 2>&1'; } | crontab -
